...
info.add_run('Document Version: 3.0\n\n').bold = True
...
changes_headers = ['Change', 'v2.0', 'v3.0']
changes_rows = [
    ['Admin permissions list', 'Missing admin.access in code reference', 'Added admin.access to list'],
    ['Route protection table', 'Not included', 'Added new section'],
    ['Implementation reference', 'Missing encryption.js', 'Added encryption.js'],
    ['Document references', 'References v2 docs', 'Updated to v3'],
]
...
# Save document
output_path = r"c:\Users\rahul.ramagiri\Documents\git\pdcrApiDataMaskingUI\pdcrApiDataMaskingUI\docs\RBAC_Access_Matrix_v3.docx"
doc.save(output_path)

print(f"\nDocument saved successfully: {output_path}")
print("RBAC Access Matrix v3 DOCX created!")
