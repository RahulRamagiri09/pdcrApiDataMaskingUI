...
doc.add_paragraph()
add_text('See RBAC_Access_Matrix_v4.md for detailed permission matrix.')
...
add_code_block('''VITE_ENCRYPTION_ENABLED=true
...
add_text('Frontend: Port 5000 (Vite Development Server)')
...
add_heading('9.3 Development Commands', 2)
cmd_headers = ['Action', 'Command']
cmd_rows = [
    ['Start Dev Server', 'npm run dev'],
    ['Build Production', 'npm run build'],
    ['Preview Build', 'npm run preview'],
]
create_table(cmd_headers, cmd_rows)
...
changes_headers = ['Area', 'v3.0', 'v4.0']
changes_rows = [
...
# Save document
output_path = r"c:\Users\rahul.ramagiri\Documents\git\pdcrApiDataMaskingUI\pdcrApiDataMaskingUI\docs\Technical_Architecture_v4.docx"
doc.save(output_path)

print(f"\nDocument saved successfully: {output_path}")
print("Technical Architecture v4 DOCX created!")
