...
See `RBAC_Access_Matrix_v2.md` for detailed permission matrix.
...
This technical architecture document provides a comprehensive overview of the PII Masking Tool system design for Version 2.0, including:
